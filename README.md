...
[![Version](https://img.shields.io/badge/version-v1.5.0-blue?style=flat-square)](https://github.com/jonisnet/hki-parcels-card/releases/latest)
...
**Track parcels from PostNL, DHL, DPD, GLS, Dragonfly, Trunkrs, Cainiao and Hermes in a single Home Assistant card** — with animated banners, letter scan images, automatic sensor detection, a "+ Add parcel" control for account-less carriers, and a full visual editor.
...
- **Multi-carrier** — PostNL, DHL, DPD, GLS, Dragonfly, Trunkrs, Cainiao and Hermes side by side in one card, each with its own branded logo, van animation and banner
...
- **Add a parcel from the card** — account-less carriers (GLS, Dragonfly, Trunkrs, Cainiao, Hermes) get a "+ Add parcel" control that registers a new Track & Trace number directly; see [Add parcel support](#add-parcel-support) below for why PostNL/DHL/DPD don't
...
- [ha-parcel-integrations](https://github.com/ha-parcel-integrations) — PostNL, DHL, DPD, GLS, Dragonfly, Trunkrs, Cainiao and Hermes integrations, all sharing one canonical parcel format
