...
2. A JavaScript error occurred — open the browser console (F12) and check for errors. Report any errors on the [issue tracker](https://github.com/jonisnet/ha-parcel-card/issues).
